<template>
  <form
    class="flex flex-col gap-4 rounded-2xl bg-white p-5 ring-1 ring-inaka-nude"
    @submit.prevent="save"
  >
    ...
    <button
      type="submit"
      :disabled="saving"
      class="self-start rounded-lg bg-inaka-terra px-5 py-2.5 text-xs font-semibold text-inaka-cream hover:opacity-90"
    >
