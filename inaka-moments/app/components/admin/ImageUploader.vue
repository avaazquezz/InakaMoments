  ...
  <div class="grid grid-cols-3 gap-3 sm:grid-cols-4">
    ...
    >
      ...
      <div class="absolute inset-0 flex items-center justify-center gap-1.5 bg-inaka-terra/50 transition-all md:bg-inaka-terra/0 md:opacity-0 md:group-hover:bg-inaka-terra/50 md:group-hover:opacity-100 md:focus-within:opacity-100">
        <button
          type="button"
          class="flex h-7 w-7 items-center justify-center rounded-full bg-white/90 text-inaka-terra disabled:opacity-30"
          :disabled="i === 0"
        ...
        <button
          type="button"
          class="flex h-7 w-7 items-center justify-center rounded-full bg-white/90 text-red-600"
    ...
    >
      ...
      <div class="absolute inset-0 flex items-center justify-center bg-white/50">
        ...
        <span
          v-else
          class="rounded bg-red-600 px-2 py-0.5 text-[10px] font-semibold text-white"
        >Error</span>
      </div>
    </div>
