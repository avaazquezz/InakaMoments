  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="flex flex-wrap gap-2">
      <span
        ...
        :key="i"
        class="inline-flex items-center gap-1.5 rounded-full bg-inaka-nude/60 px-3 py-1 text-xs font-medium text-inaka-terra"
      >
        {{ item }}
        <button
          type="button"
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <button
        type="button"
        class="shrink-0 rounded-lg border border-inaka-beige px-3 py-2 text-xs font-semibold text-inaka-terra hover:bg-inaka-nude/40"
        @click="add"
      >
        Añadir
      </button>
