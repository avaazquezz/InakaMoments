<template>
  <footer class="relative overflow-hidden bg-inaka-terra text-inaka-cream">
    ...
    <div class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-inaka-gold/40 to-transparent" aria-hidden="true" />
    ...
    <div class="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col gap-5">
          ...
          >
            <span class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-inaka-cream/10 ring-1 ring-inaka-gold/40 transition-transform group-hover:scale-105">
              <Icon name="lucide:instagram" class="h-6 w-6 text-inaka-gold" aria-hidden="true" />
            </span>
            <div class="min-w-0">
            ...
            <Icon name="lucide:arrow-right" class="ml-auto h-4 w-4 shrink-0 text-inaka-gold/70 transition-transform group-hover:translate-x-1" aria-hidden="true" />
          </a>
        </div>
        ...
        <div>
          ...
          <ul class="flex flex-col gap-4">
            <li>
              ...
              >
                <Icon name="lucide:mail" class="mt-0.5 h-4 w-4 shrink-0 text-inaka-gold/60" aria-hidden="true" />
                {{ contacto.email }}
              </a>
            </li>
            <li class="inline-flex items-start gap-3 text-sm text-inaka-cream/65">
              <Icon name="lucide:map-pin" class="mt-0.5 h-4 w-4 shrink-0 text-inaka-gold/60" aria-hidden="true" />
              {{ contacto.ubicacion }}
            </li>
          </ul>
        </div>
      ...
      <div class="flex flex-col items-center justify-between gap-4 py-6 sm:flex-row">
        ...
        <div class="flex items-center gap-5">
          <NuxtLink to="/politica-privacidad" class="rounded text-xs text-inaka-cream/40 outline-none transition-colors hover:text-inaka-cream/70 focus-visible:ring-2 focus-visible:ring-inaka-gold">Política de privacidad</NuxtLink>
          <span class="h-3 w-px bg-inaka-cream/20" />
          <NuxtLink to="/aviso-legal" class="rounded text-xs text-inaka-cream/40 outline-none transition-colors hover:text-inaka-cream/70 focus-visible:ring-2 focus-visible:ring-inaka-gold">Aviso legal</NuxtLink>
        </div>
      </div>
