<template>
  <div class="flex flex-col gap-6">
      ...
      <div class="grid grid-cols-1 gap-5 lg:grid-cols-3">
        ...
        <div class="flex flex-col gap-4">
          <div class="rounded-2xl bg-white p-5 ring-1 ring-inaka-nude">
            ...
            <p class="text-xs text-inaka-terra/60">
              Fuente: {{ lead.source ?? '—' }}
            </p>
            <p class="text-xs text-inaka-terra/60">
          ...
          <div class="rounded-2xl bg-white p-5 ring-1 ring-inaka-nude">
            ...
            <AdminEmptyState
              v-if="lead.quotes.length === 0"
              title="Ninguno todavía"
            />
            <ul
              v-else
    ...
    <AdminConfirmDialog
      ...
      message="Se borrarán también sus actividades."
      danger
...
async function addActivity() {
  ...
  try {
    ...
    toast.error(apiErrorMessage(err, 'No se ha podido añadir la nota.'))
  }
}
