      ...
      <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <blockquote class="flex-1 text-inaka-terra/75 leading-relaxed">
              "{{ t.quote }}"
            </blockquote>
            <figcaption class="mt-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p
                  v-if="t.event_type"
                  class="text-xs text-inaka-terra/50"
                >
        ...
        <div
          v-else
          class="mx-auto flex max-w-xl flex-col items-center justify-center py-16 text-center"
        >
          <Icon
            name="lucide:star"
            class="mb-4 h-12 w-12 text-inaka-gold/40"
            aria-hidden="true"
          />
          <h2 class="mb-3 font-display text-2xl font-bold text-inaka-terra">
            Aún estamos recopilando reseñas
          </h2>
...
import { buildBusinessReviewsSchema } from '~~/shared/schema'
...
useJsonLd('reviews', () => buildBusinessReviewsSchema('Inaka Moments', 'https://inakamoments.com', testimonios.value))
</script>
