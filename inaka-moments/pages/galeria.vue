          ...
          >
            ...
            >
              ...
              <div class="absolute inset-x-0 bottom-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-500 opacity-0 group-hover:opacity-100">
                ...
                <span class="block text-inaka-cream/70 text-xs mt-1">{{ item.categoria }}</span>
              </div>
            </div>
          </TransitionGroup>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Explora la galería de trabajos de Inaka Moments. Bodas, comuniones, cumpleaños y eventos corporativos decorados con alma.',
    },
